...
def generate_valid_spawn_actions(board) -> list[SpawnAction]:
...
def generate_valid_spread_actions(board, maximizing_player) -> list[SpreadAction]:
...
if __name__ == '__main__':
    ...
    initial_state = {
        HexPos(3, 3): CellState(PlayerColor.RED, 1),
        HexPos(3, 4): CellState(PlayerColor.BLUE, 1),
        HexPos(3, 5): CellState(PlayerColor.BLUE, 1)
    }

    board = OurBoard(initial_state)
